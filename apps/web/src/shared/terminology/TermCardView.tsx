...
interface TermCardViewProps {
  ...
  hideSavedNote?: boolean | undefined;
}
...
export function TermCardView({
  ...
  const showSavedNote =
    !hideSavedNote && alreadyInNotebook && layout !== 'entry' && !onToggleBookmark;
              ...
              <p className="term-card-also-line">
                ...
                {aliases.map((alias) => (
                  <span key={`${alias.text}-${alias.pinyin}`} className="term-card-also-item">
                    ...
                    {alias.pinyin ? (
                      <span className="term-alias-pinyin">{alias.pinyin}</span>
                    ) : null}
                  </span>
                ))}
              </p>
            ...
            <section className="term-card-sense" aria-label={t('terminology.meaning')}>
              ...
              {english ? (
                <p className="term-card-english">
                  <span className="term-card-english-kicker">
                    {t('terminology.englishEquivalent')}
                  </span>
