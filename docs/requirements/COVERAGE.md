...
| 1.4 | Learning and Language Preferences | `US-LANG-01`, `US-LANG-02`, `US-LANG-03` | Owners: delivered `VS-004` (default explanation language); shaping `VS-008` (temporary session switch on LESSON); proposed `VS-014`; language dimensions remain independent. |
...
| 4.1 | Course Catalog and Launch Scope | `US-COURSE-01` | Owners: delivered `VS-005` (admin package publish); shaping `VS-008` (student subject-agnostic browse of published packages; partial story — no prerequisites/linked practice/entitlement). |
| 4.2 | Official Syllabus Source and Platform Curriculum Alignment | `US-SYL-01`, `US-ADM-03` | Owners: delivered `VS-005` (admin outline and language-keyed official-source link(s) for en and/or zh-CN PDF editions); shaping `VS-008` (student official-source panel with 1–2 language-edition open actions + outline + product coverage; personal column = content progress only; parent actor deferred); YukCSCA-authored Bahasa Indonesia, English, and Simplified Chinese outline summaries remain distinct from platform objectives and link to the official source(s); undeclared official dates are recorded as not stated. |
| 4.3 | Focused Learning-Unit Content | `US-COURSE-02`, `US-COURSE-04` | Owners: delivered `VS-005` (admin LESSON/TEXT/MATH/IMAGE); shaping `VS-008` (student LESSON reader + content progress; video/`US-COURSE-04` media deferred). |
| 4.4 | Explanation-Language and Exam-Language Bridging | `US-LANG-03`, `US-COURSE-02` | Owners: delivered `VS-004`; shaping `VS-008` (lesson explanation-language toggle; no exam-track lesson split); proposed `VS-014`. |
...
| 4.6 | In-Course Assessment | `US-COURSE-03` | Owners: delivered `VS-005` (admin questions/mock definition); proposed `VS-009`. |
