...
| 4.5 | Chinese Mathematics Terminology Preview and In-Question Support | `US-TERM-01`, `US-TERM-02`, `US-TERM-03` | Owner: implemented (backend + production frontend) [`VS-010A`](../delivery/VS-010A-chinese-terminology.md) (`VS-010A-R10-accepted`; `D-01` loop A). Status remains `CONTRACT_READY` until product-owner journeys. |
...
| 5.3 | Hints, Language Assistance, and Solutions | `US-TERM-01`, `US-HINT-01` | Owners: delivered `VS-009` mathematical tiered hints + post-submit solutions (`VS-009-R8-accepted`); implemented [`VS-010A`](../delivery/VS-010A-chinese-terminology.md) (Chinese language-assist + terminology; `VS-010A-R10-accepted`; production Language-help UI). Status remains `CONTRACT_READY` until product-owner journeys. |
