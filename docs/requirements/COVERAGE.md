...
| --- | --- | --- | --- |
| 1.1 | Registration and Login | `US-AUTH-01`, `US-AUTH-02`, `US-AUTH-03`, `US-AUTH-04`, `US-PROF-03`, `US-ADMIN-01` | `VS-000` implements Google-only production authentication. `VS-074` and `VS-075` are proposed roadmap rows for `US-AUTH-03` and `US-AUTH-04`; neither has an accepted brief or contract. PX-002 previews those flows through deterministic fixtures without creating production identity or closing either story. |
