...
- [ ] Backend + frontend + migration implement the same states from checkpoint.
- [ ] All AC rows have named evidence.
- [ ] Authorization, privacy, and no-key-leakage reviewed.
...
| Backend tests                | Not run — implementation may start from `CONTRACT_READY`                                                                                                                                                                                                                                                                                  |
| Frontend tests               | Not run — implementation may start from `CONTRACT_READY`                                                                                                                                                                                                                                                                                  |
