...
| -------------------------------------------- | ---------------------------------------------- | --------------------------- | ------------------------------------------------------------- | ---------------------------------- | -------------------------------------- |
| Public Home and For Parents                  | Product positioning; `US-TRIAL-01`             | Surface complete            | Preview content                                               | `VS-027`                           | Routes and responsive screenshots      |
| Product/trial detail                         | 11.1–11.2; `US-TRIAL-01`–`03`, `US-PRODUCT-01` | Flow complete               | Preview                                                       | `VS-027`                           | Route tests and journey                |
...
| Email/password register/verify/login/recover | 1.1; `US-AUTH-03`, `US-AUTH-04`                | Flow complete               | Preview                                                       | `VS-002`, `VS-003`                 | Boundary tests and Journey A           |
| Role selection                               | 1.2–1.3; `US-PROF-01`, `US-PROF-03`            | Flow complete               | Mixed                                                         | `VS-001`, `VS-005`                 | Route/guard tests                      |
...
| Parent activation                            | 1.1–1.3; `US-PROF-03`                          | Flow complete               | Preview                                                       | `VS-005`                           | Journey B                              |
| Parent-created student                       | 2.1; `US-FAM-00`, `US-FAM-04`                  | Representative flow         | Preview                                                       | `VS-006`                           | Journey B and conflict test            |
| Invitation/link/unlink                       | 2.2–2.3; `US-FAM-01`–`03`                      | Flow complete               | Preview                                                       | `VS-007`, `VS-008`                 | State tests                            |
| Parent overview/privacy                      | 10.1, 10.4; `US-PARENT-01`, `US-FAM-02`        | Surface complete            | Preview                                                       | `VS-026`                           | Screenshot and privacy test            |
| Weekly report/risk                           | 10.2; `US-PARENT-02`, `US-PARENT-03`           | Surface complete            | Preview                                                       | `VS-026`                           | Scenario tests                         |
| Entitlement/service summary                  | 10.3; `US-PARENT-04`                           | Surface complete            | Preview                                                       | `VS-029`                           | Parent route test                      |
| Checkout/order                               | 11.3; `US-PAY-01`                              | Flow complete               | Preview                                                       | `VS-028`                           | Journey C and duplicate-confirm test   |
| Provider outcome/entitlement                 | 11.3; `US-PAY-02`                              | Representative lifecycle    | Preview                                                       | `VS-028`                           | Reducer/state tests                    |
| Orders/receipts                              | 11.5; `US-ORDER-01`                            | Surface complete            | Preview                                                       | `VS-028`                           | Paid/unpaid tests                      |
| Refund/duplicate payment                     | 11.5; `US-REFUND-01`                           | Representative flow         | Preview                                                       | `VS-030`                           | Eligibility/state tests                |
| Manual renewal                               | 11.4; `US-RENEW-01`                            | Representative flow         | Preview                                                       | `VS-031`                           | New-order test                         |
| Notification preferences                     | 13.1; `US-NOTIFY-01`, `US-NOTIFY-02`           | Surface complete            | Preview                                                       | `VS-025`                           | Preference/default tests               |
| Account export/deletion                      | 1.2; `US-ACCOUNT-01`, `US-ACCOUNT-02`          | Signposted/explanation only | Preview                                                       | `VS-009`, `VS-010`                 | Route/copy tests                       |
| Support                                      | 13.2; `US-SUPPORT-01`                          | Representative flow         | Preview                                                       | `VS-032`                           | Context-safety test                    |
...
| Evidence                                     | Result                                                                                                                                                                |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Documentation sufficiency                    | Complete for behavior revision 5; revision 6 changes roadmap references only                                                                                          |
...
| -------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 6        | 2026-07-28 | Remapped proposed production owners to the capability-sized P0 roadmap and removed internal slice IDs from localized preview copy without changing PX scope or state behavior.                                                                                                                     |
| 5        | 2026-07-27 | Marked `DONE` after product-owner acceptance of the bounded journeys, while explicitly recording that the text-heavy/basic UI and fixture flows are not complete requirement or production-design representations; recorded future credential ownership and a reuse/rewrite/delete promotion gate. |
