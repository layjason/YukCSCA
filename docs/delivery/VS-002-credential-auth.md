...
| Backend tests                | Not run — no implementation change                                                                                                                                                                |
| Frontend tests               | Not run — no implementation change                                                                                                                                                                |
| Frontend visual review       | Not run — no implementation change                                                                                                                                                                |
| End-to-end/manual flow       | Not run — no implementation change                                                                                                                                                                |
