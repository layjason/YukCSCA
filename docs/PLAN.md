...
| Current production slice     | [`VS-002`](delivery/VS-002-credential-auth.md) credential authentication — `CONTRACT_READY`          |
...
| [`VS-002`](delivery/VS-002-credential-auth.md)    | Register, verify, and sign in with production credentials without inferring a role | `US-AUTH-03`               | `VS-000`; email and abuse decisions    | `CONTRACT_READY` |
