...
Each row is one capability-sized closed loop or one reliability-critical state transition. Delivered IDs `VS-000`–`VS-003` remain immutable. Rows without an accepted delivery brief are planning hypotheses and may be refined only before shaping.
...
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ----------------------------------- | ---------- |
| `VS-004` | Maintain the student profile and default explanation language                                                                                                   | `US-PROF-02`, `US-LANG-01`                                                             | `VS-001`                            | `PROPOSED` |
| `VS-005` | Configure the first platform admin account and open the baseline admin dashboard; no admin-account management UI                                                | `US-ADMIN-01`                                                                          | `VS-000`; configured admin identity | `PROPOSED` |
| `VS-006` | Add and publish one official CSCA syllabus version with its official module and topic hierarchy                                                                 | `US-ADM-03`, `US-ADM-05`                                                               | `VS-005`                            | `PROPOSED` |
| `VS-007` | Create YukCSCA learning objectives, map them to official topics, and publish the first lessons, terminology, questions, remediation content, and one mock paper | `US-ADM-02`, `US-ADM-04`, `US-ADM-05`                                                  | `VS-006`                            | `PROPOSED` |
| `VS-008` | Browse syllabus coverage and complete or resume one focused learning unit                                                                                       | `US-COURSE-01`, `US-SYL-01`, `US-COURSE-02`, `US-COURSE-04`, `US-LANG-02`              | `VS-004`, `VS-007`                  | `PROPOSED` |
| `VS-009` | Complete a checkpoint or topic-practice set and close one mistake → remediation → revalidation loop                                                             | `US-COURSE-03`, `US-PRACTICE-01`, `US-HINT-01`, `US-MISTAKE-01`–`03`                   | `VS-007`, `VS-008`                  | `PROPOSED` |
| `VS-010` | Preview, use, collect, and review required Chinese Mathematics terminology                                                                                      | `US-TERM-01`–`03`                                                                      | `VS-007`, `VS-009`                  | `PROPOSED` |
...
| `VS-012` | Select a mock, recover a timed attempt, and submit exactly once                                                                                                 | `US-MOCK-01`–`03`; requirements 7.1–7.2                                                | `VS-007`; student access            | `PROPOSED` |
...
| `VS-014` | Record a goal and confirm sourced subject and exam-language targets                                                                                             | `US-GOAL-01`–`03`, `US-LANG-03`                                                        | `VS-006`; student access            | `PROPOSED` |
| `VS-015` | Complete a diagnostic and review its evidence-bounded result                                                                                                    | `US-DIAG-01`, `US-DIAG-02`                                                             | `VS-007`, `VS-009`, `VS-014`        | `PROPOSED` |
...
- `VS-005` configures one existing verified account as the first platform admin. It does not include admin invitations, an admin-account creation page, or permission management; those are only needed before a second admin is added.
- `VS-006` stores an official syllabus version and its topics separately from YukCSCA learning objectives. `VS-007` adds the first lessons, terminology, questions, remediation content, and mock paper. Each student attempt saves the exact question and scoring data it used.
...
| Object-storage adapter  | First accepted slice that actually uploads or serves a protected file      | Ownership, signed access, malware checks, retention, deletion, and retry policy                                          |
